    ...
    <footer className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          >
            ...
            <div className="flex space-x-4">
              <Link href="https://x.com/playmetaloot" className="text-gray-600 hover:text-pink-500">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </Link>
              <Link href="https://discord.gg/U7WJBdCtjv" className="text-gray-600 hover:text-pink-500">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <Link href="https://github.com/vanha777/metaloot-sol-program" className="text-gray-600 hover:text-pink-500">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {footerLinks.map((column, index) => (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-lg rounded-xl p-6 border border-pink-200 hover:border-pink-300 transition-colors shadow-lg hover:shadow-xl"
            >
              <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-[#FF69B4] to-[#FFD700] bg-clip-text text-transparent">
                {column.title}
              </h3>
        ...
        <motion.div 
          ...
          className="border-t border-pink-200 mt-12 pt-8 text-center text-gray-600 text-sm"
        >
